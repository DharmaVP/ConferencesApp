...
public class GetEventToEditCommand implements Command {
        private static Logger LOGGER = LogManager.getLogger(GetEventToEditCommand.class);
        private EventService eventService;
        private ReportService reportService;

        public GetEventToEditCommand() {
        ...
        public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException {
            String page = EVENT_PAGE_TO_EDIT;
            EventDTO event;
