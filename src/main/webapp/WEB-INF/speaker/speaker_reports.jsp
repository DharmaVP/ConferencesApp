...
<c:set var="base" value="controller?action=view_speaker_reports"/>
...
<c:set var="setSpeakerOk" value="&speaker="/>
...
<div class="w3-main" style="margin-left:250px; margin-top: 25px; margin-bottom: 75px">
  ...
  <div class="w3-row">
    <div class="w3-padding-64">
      <a href="${base}${setSpeaker}true${setModeratorOk}true${setSpeakerOk}false">Assigned to me</a>
      <a href="${base}${setSpeaker}true${setModeratorOk}false${setSpeakerOk}false">Proposed by me</a>
      <a href="${base}${setSpeaker}true${setModeratorOk}false${setSpeakerOk}true">On approval by moderator</a>
      <a href="${base}${setSpeaker}false${setModeratorOk}false${setSpeakerOk}false">Free</a>
      <a href="${base}${setSpeaker}true${setModeratorOk}true${setSpeakerOk}true">Accepted</a>
    </div>
    <table class="w3-table w3-striped">
      ...
      <c:forEach var="report" items="${reportList}">
        <tr>
          ...
          <td>
            <c:choose>
              <c:when test="${report.acceptedByModerator == true and report.acceptedBySpeaker == false}">
              ...
              <c:when test="${report.acceptedByModerator == false and report.acceptedBySpeaker == true}">
                <form action="controller" method="POST">
                  <input type="hidden" name="action" value="accept_to_speak">
                  <input type="hidden" name="approve" value="false">
                  <input type="hidden" name="report_id" value="${report.id}">
          ...
          <td>
            <form action="controller" method="GET">
              ...
              <input type="hidden" name="report_id" value="${report.id}">
              <button class="w3-button w3-green" type="submit">View</button>
            </form>
          </td>
        </tr>
      </c:forEach>
